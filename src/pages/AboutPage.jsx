...
const stats = [
  ...
  { value: `${brandDNA.reviews.rating.toFixed(1)}★`, label: `${brandDNA.reviews.googleLabel} & ${brandDNA.reviews.facebookLabel}` },
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative px-8 lg:pl-16 lg:pr-8 py-16">
            ...
            <div className="flex flex-col gap-4 text-cool text-sm leading-relaxed max-w-lg">
              ...
              <p>
                That commitment has earned us a {brandDNA.reviews.rating.toFixed(1)}-star rating on both Google and Facebook, hundreds of completed projects across {brandDNA.company.serviceRegion}, and more referrals than we can count. We believe the best advertisement is work you're proud of.
              </p>
            </div>
