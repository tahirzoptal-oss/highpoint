...
export const SERVICE_PAGES = [
  // ────────────────────────────────────────────────────────────── Roof Replacement
  {
    ...
    body: [
      ...
      '',
      'A dependable replacement involves more than installing new shingles. We evaluate the decking and install the required protective layers, flashing details, ventilation components, and finish materials so the system works together.',
    ].join('\n'),
    benefits: [
      ...
      { title: 'Detailed Installation', body: 'Our crew pays close attention to alignment, fastening, transitions, penetrations, ridges, valleys, and other details that affect performance.' },
      { title: 'Clean and Respectful Worksites', body: 'We organize the project carefully, protect the surrounding property, and complete a thorough cleanup when the work is finished.' },
      { title: 'Clear Project Communication', body: 'You receive practical information about the scope, material choices, schedule, and next steps throughout the replacement.' },
    ],
    included: [
