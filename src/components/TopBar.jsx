...
// Rule 63: TopBar honors brandDNA.nav_treatment for contrast-flip when
// the logo would vanish against the default light-mode flipped surface.
export default function TopBar() {
  const navDark = brandDNA.nav_treatment === 'dark';
  const themeKeep = navDark ? ' theme-keep-dark' : '';
  return (
    <div className={`hidden lg:block text-white text-sm py-2 px-4 bg-navy-dark${themeKeep}`}>
