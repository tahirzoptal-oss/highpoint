...
export default function OurWork() {
  ...
  // No captured project photos -> hide the gallery instead of crashing the
  // SSG prerender on projects[active] being undefined.
  ...
  return (
    <section id="gallery" className="relative py-16 overflow-hidden bg-grid bg-navy-slate">
