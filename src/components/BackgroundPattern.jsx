 ...
 * `templates/capstone/src/assets/bg-patterns/{shape_motif}.svg` as an
 ...
 * chevron | diamond | cross-hatch | mountain | shingle | blueprint-grid | topographic.
 *
...
const VALID_MOTIFS = new Set([
  ...
  'chevron', 'diamond', 'cross-hatch', 'mountain', 'shingle',
  'blueprint-grid', 'topographic', 'herringbone',
])
