...
export default function WhyChooseUs() {
  return (
    <section id="why" className="relative overflow-hidden bg-grid bg-navy-slate">
      ...
      <div className="lg:hidden relative h-52 overflow-hidden">
        ...
        />
        <div className="absolute inset-x-0 bottom-0 h-20" style={{ background: 'linear-gradient(to top, rgb(var(--fade-navy-slate)), transparent)' }} />
      </div>
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="hidden lg:block relative overflow-hidden" style={{ minHeight: 640 }}>
          ...
          />
          {/* Left-edge fade */}
          <div className="absolute inset-y-0 left-0 w-44" style={{ background: 'linear-gradient(to right, rgb(var(--fade-navy-slate)), transparent)' }} />
        </div>
      </div>
