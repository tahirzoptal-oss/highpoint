...
export default function Ticker() {
  return (
    <div className="py-2.5 overflow-hidden bg-navy">
      <div className="flex items-center justify-center lg:justify-around gap-4 px-4 sm:px-6">
        {items.map((item, i) => (
          <div key={i} className={`items-center gap-3 whitespace-nowrap ${i === 0 ? 'flex' : 'hidden lg:flex'}`}>
